...
//		 1 - 2
//		int 型の変数 x に数値 11 を代入し、x の値を“x=11”
...
//		 1 - 7
//		int 型の変数 x、y に任意の数値を代入し、x の値を y に、y の値を
//      x に入れ替えて x と y の値を表示するプログラムを作成しなさい。
...
//		 1 - 9
//		int 型の変数 x に任意の数値を代入し、x を 2 倍、3 倍、4 倍した
		//結果を表示するプログラムを作成しなさい。
//		int x = 5;
